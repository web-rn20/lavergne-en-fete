...
const infoPratiques = [
  ...
  },
  {
    ...
    titre: "Tenue",
    description: "Venez comme vous êtes ! Mais prévoyez des chaussures confortables pour le jardin.",
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="mb-16">
          ...
          <div className="relative w-full rounded-2xl overflow-hidden bg-white">
            <div className="aspect-video md:aspect-[21/9]">
              <iframe
                src={`https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=Chez+Granny,+35+chemin+de+l'église,+31700+Cornebarrieu,+France&zoom=16&maptype=roadmap`}
